function optimTraj
    ...
    majIterLimField = uicontrol('Style','Edit',...
         'Parent',tab3,...
         'Enable','On',...
         'Position',[125 335 70 25]);
    uicontrol('Style','Text',...
         'Parent',tab3,...
         'String',{'Max iterations' 'per segment'},...
         'Position',[10 332 100 30]);
    discrPointsField = uicontrol('Style','Edit',...
         'Parent',tab3,...
         'Enable','On',...
         'Position',[125 373 70 25]);
    uicontrol('Style','Text',...
         'Parent',tab3,...
         'String',{'Discretization' 'points per segment'},...
         'Position',[10 370 100 30]);
    plotStatesCheckbox = uicontrol('style','checkbox',...
         'Parent',tab3,...
         'String','Plot States',...
         'Position',[300 370 70 15],...
         'Value',1);
    plotControlsCheckbox = uicontrol('style','checkbox',...
         'Parent',tab3,...
         'String','Plot Controls',...
         'Position',[300 350 90 15],...
         'Value',1);
    ...
    function optimize_Callback(~,~)
        ...
        if any(any(checkForEmptyValues))
            ...
            configuration.plotStates = plotStatesCheckbox.Value;
            configuration.plotControls = plotControlsCheckbox.Value;
