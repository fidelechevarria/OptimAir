function soln = optimTrajDirCol(problem)
...
%
%       Analytic Gradients:
%           Both the "trapezoid" and "hermiteSimpson" methods in optimTrajDirCol
...
%
%       * if options is a struct array, the optimTrajDirCol will run the optimization
...
for iter=1:nIter
    ...
    if P.options.verbose > 0    %then print out iteration count:
        disp('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
        disp(['Running optimTrajDirCol, iteration ' num2str(iter)]);
    end
    ...
    switch P.options.method
        ...
        otherwise
            error('Invalid method. Type: ''help optimTrajDirCol'' for a valid list.');
    end
