function OptimAir
    ...
    % OptimAir: Red Bull Air Race Team 26 Flight Trajectory Optimization Software
    ...
    f.Name = 'OptimAir - Flight Trajectory Optimization Tool';
    ...
    DynamicModel_table = uitable('Parent',tab2,...
        ...
        'Min alt [m]';'Max alt [m]';'Min alpha [°]';'Max alpha [°]';...
        'Max thrust [N]';'Max Ang Vel x-axis [°/s]';'Init Earth Vel [m/s]';...
        'Wind Vel [m/s]';'Wind Heading [°]';'Wind Elevation [°]'},...
        'ColumnEditable',true,...
